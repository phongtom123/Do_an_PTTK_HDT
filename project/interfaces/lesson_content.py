...
def show_lesson_content(root, main_frame, show_in_main, in_reading_mode):
    ...
    lesson_title_label.pack(pady=(BAR_HEIGHT + 10, 0))
    ...
    notebook.place(relx=0.01, rely=0.01, relwidth=0.98, relheight=0.9)
    ...
    def update_text():
        ...
        # ✅ Cập nhật tiêu đề và thanh tiến trình
        lesson_title_label.config(text=f"Đang học: Reading {reading_index + 1}")
        draw_progress(calc_progress())

        # ✅ Hiển thị hoặc ẩn nút Hoàn thành
    ...
    complete_btn = tk.Button(button_frame, text="✅ Hoàn thành",
